...
OUT_OF_SCOPE_MESSAGES: Dict[str, str] = {
    "en": "MITRA AI helps with government health-related schemes and services. Please ask a health-related question.",
    "hi": "मित्रा AI केवल सरकारी स्वास्थ्य योजनाओं और सेवाओं में सहायता करता है। कृपया स्वास्थ्य से संबंधित प्रश्न पूछें।",
    "ta": "மித்ரா AI அரசு சுகாதாரம் மற்றும் நலத்திட்டங்களுக்கு மட்டுமே உதவுகிறது. தயவுசெய்து சுகாதாரம் தொடர்பான கேள்வியைக் கேளுங்கள்.",
    "te": "మిత్రా AI ప్రభుత్వ ఆరోగ్య పథకాలు మరియు సేవలలో మాత్రమే సహాయం చేస్తుంది. దయచేసి ఆరోగ్యానికి సంబంధించిన ప్రశ్నను అడగండి.",
    "kn": "ಮಿತ್ರ AI ಸರ್ಕಾರಿ ಆರೋಗ್ಯ ಯೋಜನೆಗಳು ಮತ್ತು ಸೇವೆಗಳಲ್ಲಿ ಮಾತ್ರ ಸಹಾಯ ಮಾಡುತ್ತದೆ. ದಯವಿಟ್ಟು ಆರೋಗ್ಯ ಸಂಬಂಧಿತ ಪ್ರಶ್ನೆಯನ್ನು ಕೇಳಿ.",
    "ml": "മിത്ര AI സർക്കാർ ആരോഗ്യ പദ്ധതികളിലും സേവനങ്ങളിലും മാത്രമേ സഹായിക്കൂ. ദയവായി ആരോഗ്യവുമായി ബന്ധപ്പെട്ട ചോദ്യം ചോദിക്കുക.",
    "mr": "मित्रा AI केवळ शासकीय आरोग्य योजना आणि सेवांमध्ये मदत करते. कृपया आरोग्यविषयक प्रश्न विचारा.",
    "bn": "মিত্র AI শুধুমাত্র সরকারি স্বাস্থ্য প্রকল্প এবং পরিষেবায় সহায়তা করে। অনুগ্রহ করে স্বাস্থ্য সম্পর্কিত কোনো প্রশ্ন জিজ্ঞাসা করুন।",
    "gu": "મિત્રા AI માત્ર સરકારી સ્વાસ્થ્ય યોજનાઓ અને સેવાઓમાં મદદ કરે છે. કૃપા કરીને સ્વાસ્થ્ય સંબંધિત પ્રશ્ન પૂછો.",
}
